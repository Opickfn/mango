      ...
      <CardHeader className="bg-muted/30 border-b border-border/50 space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-xl bg-mango-blue/10 text-mango-blue">
              <History size={20} />
            </div>
            <div>
      ...
      <CardContent className="p-0">
        {loading ? (
          <div className="flex justify-center py-20">
            <Loader2 className="h-8 w-8 animate-spin text-mango-blue" />
          </div>
        ) : history.length === 0 ? (
            ...
            {history.map((item) => (
              <div key={item.id} className="p-6 hover:bg-muted/20 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <Link href={`/workspace/umkm/assessment/${item.id}/result`}>
                  <Button variant="ghost" className="rounded-xl group gap-2 text-mango-blue hover:text-mango-hover hover:bg-mango-blue/5">
                    Lihat Detail
