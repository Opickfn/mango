    ...
    >
      <div className="mb-6">
        <Button 
          ...
          className="rounded-xl gap-2 text-muted-foreground hover:text-mango-blue"
        >
          <ArrowLeft size={18} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Main Score Card */}
        <Card className="lg:col-span-1 border-mango-blue/20 shadow-xl rounded-3xl bg-mango-blue text-white overflow-hidden relative">
        ...
        <Card className="lg:col-span-2 border-border/50 shadow-xl rounded-3xl overflow-hidden">
          <CardHeader className="bg-muted/30 border-b border-border/50">
            <CardTitle className="text-mango-blue flex items-center gap-2">
        ...
        <Card className="lg:col-span-3 border-border/50 shadow-xl rounded-3xl">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-mango-blue">
          ...
          <CardContent className="space-y-4">
            {data.recommendations?.map((rec: any) => (
              <motion.div 
                ...
                className="flex items-start gap-4 p-4 rounded-2xl bg-muted/30 border border-border/50 hover:border-mango-blue/30 transition-colors"
              >
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-sm uppercase tracking-tight text-mango-blue">
                      {rec.category?.name}
                    </span>
        ...
        <Card className="lg:col-span-3 border-border/50 shadow-sm rounded-3xl bg-accent/5 border-dashed border-accent/30">
          <CardContent className="p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-mango-blue">Butuh Pendampingan Lebih Lanjut?</h3>
            ...
            <Button 
              ...
              className="bg-mango-blue hover:bg-mango-hover text-white font-bold h-14 px-8 rounded-2xl gap-2 shadow-xl shadow-mango-blue/20"
            >
