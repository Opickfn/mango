                ...
                {!isEditing ? (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="md:col-span-2 space-y-6">
                            <Card className="border-border/50 shadow-sm rounded-3xl overflow-hidden bg-white">
                                <CardHeader className="bg-muted/30 border-b border-border/50 p-6">
                                    <CardTitle className="text-lg font-bold text-mango-blue uppercase tracking-tight">Visi & Misi</CardTitle>
                                    <CardDescription>Landasan arah perkembangan bisnis Anda.</CardDescription>
                                </CardHeader>
                                <CardContent className="p-8 space-y-8">
                                    <div className="space-y-3">
                                        <h4 className="text-xs font-black uppercase text-primary tracking-widest">Visi Bisnis</h4>
                                        <p className="text-lg font-bold text-foreground leading-relaxed italic">"{formData.vision || "Belum ditentukan."}"</p>
                                    </div>
                                    <div className="space-y-3 pt-6 border-t border-dashed">
                                        <h4 className="text-xs font-black uppercase text-primary tracking-widest">Misi Utama</h4>
                                        <p className="text-sm text-foreground/80 leading-relaxed whitespace-pre-line">{formData.mission || "Belum ditentukan."}</p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-border/50 shadow-sm rounded-3xl overflow-hidden bg-white">
                                <CardHeader className="bg-muted/30 border-b border-border/50 p-6">
                                    <CardTitle className="text-lg font-bold text-mango-blue uppercase tracking-tight">Kinerja Operasional</CardTitle>
                                ...
                                <CardContent className="p-8 space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Estimasi Omzet Tahunan</p>
                                            <Badge className="bg-success/10 text-success border-success/20 rounded-lg px-3 py-1 font-bold text-sm">
                                                Rp {new Intl.NumberFormat().format(parseFloat(formData.annual_revenue || "0"))}
                                            </Badge>
                                        </div>
                                    </div>
                                </CardContent>
                        ...
                        <div className="md:col-span-1">
                            <Card className="border-border/50 shadow-sm rounded-3xl overflow-hidden bg-slate-900 text-white p-6">
                                <CardHeader className="p-0 mb-6">
                                    <CardTitle className="text-xs font-black uppercase tracking-widest text-primary">Strategic Overview</CardTitle>
                                </CardHeader>
                                <CardContent className="p-0 space-y-6">
                                    <div className="flex flex-col items-center py-4">
                                        ...
                                        <p className="text-xs font-medium text-center text-white/60 leading-relaxed px-4">
                    ...
                    <Card className="border-primary/20 shadow-xl rounded-3xl overflow-hidden bg-white ring-4 ring-primary/5">
                        <CardHeader className="bg-primary/5 border-b border-primary/10 p-8 flex flex-row items-center justify-between">
                            <div>
                                <CardTitle className="text-xl font-black uppercase tracking-tight text-mango-blue flex items-center gap-2">
                        ...
                        <form onSubmit={handleSubmit}>
                            <CardContent className="p-8 space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Visi Bisnis</Label>
                                    <Input 
                                        value={formData.vision}
                                        onChange={(e) => setFormData({...formData, vision: e.target.value})}
                                        placeholder="Contoh: Menjadi produsen tekstil ramah lingkungan nomor satu di Indonesia"
                                        className="h-12 rounded-xl bg-muted/30 border-transparent focus:bg-background transition-all font-bold"
                                        required
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Misi Bisnis</Label>
                                    <Textarea 
                                        value={formData.mission}
                                        onChange={(e) => setFormData({...formData, mission: e.target.value})}
                                        placeholder="1. Menggunakan bahan baku organik&#10;2. Mengurangi emisi karbon..."
                                        className="rounded-xl bg-muted/30 border-transparent focus:bg-background transition-all min-h-[120px] resize-none"
                                        required
                                    />
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Omzet Tahunan (Rp)</Label>
                                        <Input 
                                            type="number"
