    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm animate-in fade-in duration-300">
      <Card className="w-full max-w-4xl max-h-[90vh] shadow-2xl border-border/50 rounded-3xl overflow-hidden flex flex-col">
        <CardHeader className="bg-muted/30 border-b border-border/50 flex flex-row justify-between items-center shrink-0">
          <div>
            <CardTitle className="text-xl font-bold text-mango-blue">Riwayat & Analisis Kematangan</CardTitle>
                    ...
                    <button
                      ...
                      className={`w-full text-left p-4 rounded-2xl transition-all border ${
                        selectedAssessment?.id === a.id 
                          ? "bg-white shadow-md border-mango-blue/20 ring-1 ring-mango-blue/5" 
                  ...
                  <div className="space-y-10">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                      <div className="space-y-1">
                        <h3 className="text-2xl font-black text-mango-blue uppercase tracking-tight">
                      ...
                      <div className="bg-mango-blue text-white p-4 rounded-3xl text-center min-w-[120px] shadow-lg shadow-mango-blue/20">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                      <div className="space-y-6">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <h4 className="font-bold text-mango-blue uppercase text-sm">Grafik Radar Dimensi</h4>
                        </div>
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <h4 className="font-bold text-mango-blue uppercase text-sm">Rekomendasi Utama</h4>
                        </div>
                          ...
                          {selectedAssessment.recommendations?.slice(0, 3).map((rec: any) => (
                            <div key={rec.id} className="p-4 rounded-2xl bg-white border border-border/50 shadow-sm">
                              <div className="flex justify-between mb-2">
                                <span className="text-[10px] font-black uppercase text-mango-blue">{rec.category?.name}</span>
