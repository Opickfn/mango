    ...
    >
      <div className="mb-8">
        <Button 
          variant="ghost" 
          onClick={() => router.back()}
          className="rounded-xl gap-2 text-muted-foreground hover:text-mango-blue px-0"
        >
          <ChevronLeft size={18} />
          Kembali ke Daftar
        </Button>
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="border-border/50 shadow-sm rounded-3xl overflow-hidden bg-white">
            <CardHeader className="bg-muted/30 border-b border-border/50 p-6">
              <CardTitle className="text-base font-bold text-mango-blue uppercase tracking-tight flex items-center gap-2">
            ...
            <CardHeader className="p-8 pb-4">
              <div className="flex justify-between items-start mb-2">
                <div className="space-y-1">
                  ...
                  <CardTitle className="text-2xl font-black text-mango-blue uppercase tracking-tight">
                    {request.topic}
                  </CardTitle>
                </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-slate-800 uppercase">{request.department?.name || "Belum Ditentukan"}</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-slate-800 uppercase">{request.assignments?.[0]?.mentor?.name || "Menunggu Delegasi"}</p>
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-slate-800 uppercase">{request.umkm?.name || "—"}</p>
                  ...
                  <div className="space-y-3">
                    ...
                    {request.sessions?.length > 0 ? (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold text-slate-800 uppercase">Sesi Terdekat</p>
