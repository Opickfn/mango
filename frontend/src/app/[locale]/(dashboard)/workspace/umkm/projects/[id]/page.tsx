        ...
        >
                    ...
                    <div className="p-6 space-y-4">
                        <div className="flex justify-between items-end">
                            <div className="space-y-1">
                                ...
                                <h3 className="text-2xl font-black text-mango-blue">{calculateProgress()}%</h3>
                            </div>
                        ...
                        <div className="h-3 w-full bg-muted rounded-full overflow-hidden">
                            <div 
                                className="h-full bg-mango-blue transition-all duration-500 ease-in-out" 
            ...
            <Dialog open={isDeliverableDialogOpen} onOpenChange={setIsDeliverableDialogOpen}>
                <DialogContent className="max-w-md rounded-3xl p-0 overflow-hidden border-none shadow-2xl">
                    <DialogHeader className="bg-muted/30 p-8 border-b">
                        <DialogTitle className="text-2xl font-black uppercase tracking-tight text-mango-blue">Kirim Laporan Tugas</DialogTitle>
            ...
            <Dialog open={isIterationDialogOpen} onOpenChange={setIsIterationDialogOpen}>
                <DialogContent className="max-w-md rounded-3xl p-0 overflow-hidden border-none">
                    <DialogHeader className="bg-muted/30 p-8 border-b">
                        <DialogTitle className="text-2xl font-black uppercase tracking-tight text-mango-blue">Tambah Tahapan Aksi</DialogTitle>
            ...
            <Dialog open={isActionPlanDialogOpen} onOpenChange={setIsActionPlanDialogOpen}>
                <DialogContent className="max-w-md rounded-3xl p-0 overflow-hidden border-none shadow-2xl">
                    <DialogHeader className="bg-muted/30 p-8 border-b">
                        <DialogTitle className="text-2xl font-black uppercase tracking-tight text-mango-blue">Tambah Tugas Baru</DialogTitle>
