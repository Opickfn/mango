            ...
            <div className="space-y-6">
                ...
                {requests.length === 0 ? (
                    <div className="text-center py-20 bg-muted/20 border-2 border-dashed rounded-3xl">
                        ...
                        <h3 className="text-lg font-bold text-mango-blue uppercase tracking-tight">Tidak Ada Permintaan Masuk</h3>
                                    ...
                                    <div className="p-6 flex-1 space-y-4">
                                        <div className="flex justify-between items-start">
                                            <div className="space-y-1">
                                                ...
                                                <CardTitle className="text-xl font-extrabold text-mango-blue">{req.machine?.name}</CardTitle>
                                            </div>
