...
const MENU_STRUCTURE: MenuItem[] = [
  ...
  {
    type: "dropdown",
    nameKey: "system_structure",
    href: "/admin/organizations",
    icon: Building2,
    roles: ["super_admin"],
    subItems: [
      { nameKey: "master_orgs", href: "/admin/organizations", icon: Building2 },
  ...
  { type: "label", nameKey: "section_business", roles: ["umkm"] },
  {
    type: "item",
  ...
  {
    type: "item",
    nameKey: "strategic_profile",
    href: "/workspace/umkm/profiles",
    icon: Briefcase,
    roles: ["umkm"]
  },
  {
  ...
  { type: "label", nameKey: "section_sharing", roles: ["umkm"] },
  {
    type: "item",
    nameKey: "machine_reservation",
    href: "/workspace/umkm/reservations",
    icon: Wrench,
    roles: ["umkm"]
  },
  {
    ...
    href: "/workspace/umkm/reservations/approvals",
    icon: ShieldCheck,
    roles: ["umkm"]
  },
