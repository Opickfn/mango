...
export default function PublicNavbar() {
  ...
  const heroIconStyle = !isScrolled
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-6 lg:px-12 h-16 lg:h-20 flex items-center justify-between relative z-[60]">
          ...
          <div className="hidden md:flex items-center gap-1">
            {/* About Link */}
            <Link href={navLinks[0].href} className={`nav-link ${linkStyle}`}>
              {navLinks[0].label}
            </Link>
            ...
            >
              <button className={`nav-link group ${linkStyle}`}>
                {t("services")}
                <ChevronDown
                  size={16}
              ...
              <AnimatePresence>
                {dropdownOpen && (
                  <motion.div
                    ...
                    className="dropdown-panel !left-0 !right-auto !w-52 !mt-1 !rounded-xl"
                  >
            ...
            {/* Testimonials Link */}
            <Link href={navLinks[1].href} className={`nav-link ${linkStyle}`}>
              {navLinks[1].label}
            </Link>
          </div>
