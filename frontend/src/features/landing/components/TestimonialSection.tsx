...
//               <div 
//                 className="relative bg-slate-900/80 backdrop-blur-md border border-slate-800/50 p-6 md:p-10 min-h-[320px] flex flex-col justify-center shadow-2xl shadow-black/50"
//                 style={{
//                   clipPath: "polygon(0 0, calc(100% - 60px) 0, 100% 60px, 100% 100%, 60px 100%, 0 calc(100% - 60px))"
//                 }}
//               >
//                 {/* Quote Icon */}
//                 <div className="absolute top-6 left-6 md:top-8 md:left-8 text-slate-800">
...
//                           </p>
//                           <p className="text-[10px] md:text-xs text-slate-400 font-sans">
...
//                 <button 
//                   onClick={prevTestimonial}
//                   className="md:hidden shrink-0 w-10 h-10 rounded-full border border-slate-800 bg-slate-900 text-slate-300 flex items-center justify-center hover:bg-[#1e477e] hover:text-white transition-all duration-300 shadow-sm cursor-pointer"
//                   aria-label="Previous Testimonial"
//                 >
//                   <ChevronLeft size={20} />
//                 </button>
