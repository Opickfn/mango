...
export const ProblemSection = () => {
    ...
    const renderVisualizer = () => {
        const cardClasses = "absolute inset-0 flex flex-col items-center justify-center w-full h-full gap-4 sm:gap-6 bg-background rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none p-6 sm:p-8 border border-border overflow-hidden";
                ...
                return (
                    ...
                    >
                        ...
                        <motion.div 
                            ...
                            viewport={{ once: false, margin: "-50px" }}
                            transition={{ duration: 0.5, delay: 0.2 }}
                            className="w-full bg-slate-100 h-6 sm:h-8 rounded-full overflow-hidden relative border border-border z-10 origin-left"
                        >
                            <motion.div 
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-center gap-3 sm:gap-4">
                                            <span className={`text-lg sm:text-xl font-bold font-mono transition-colors duration-300 ${activeProblem === id ? 'text-mango-blue' : 'text-muted-foreground group-hover:text-mango-blue/70'}`}>
                                                {index}
                                            </span>
                                            <h3 className={`text-lg sm:text-xl lg:text-2xl font-heading font-bold transition-colors duration-300 uppercase ${activeProblem === id ? 'text-mango-blue' : 'text-foreground/80 group-hover:text-foreground'}`}>
                                                {t(`items.${id}.title`)}
                                            </h3>
                                        </div>
                                        <div className="ml-2 sm:ml-4 shrink-0">
                                            ...
                                            >
                                                <ChevronDown className={`w-5 h-5 sm:w-6 sm:h-6 transition-colors ${activeProblem === id ? 'text-mango-blue' : 'text-muted-foreground group-hover:text-mango-blue/70'}`} />
                                            </motion.div>
                                        </div>
                                    </button>
