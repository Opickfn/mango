                    ...
                    <div className="lg:col-span-6 w-full flex justify-center items-center relative perspective-[3000px] order-2 lg:order-1">
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    className="absolute inset-x-8 -bottom-12 top-12 bg-mango-blue/15 blur-[80px] rounded-[4rem] -z-10 transition-opacity duration-500 group-hover:opacity-75 opacity-50"
