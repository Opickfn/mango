              ...
              >
                <a href={item.url} className="w-full flex flex-col flex-1 cursor-pointer focus:outline-none group/link">
                  ...
                  <div className="py-6 pr-6 pl-0 flex flex-col flex-1 items-start text-left w-full relative z-10">
                    <h3 className="text-xl font-heading font-bold text-card-foreground group-hover:text-mango-blue transition-colors duration-300 line-clamp-2 uppercase tracking-tight mb-3">
                    ...
                    <span className="mt-auto w-max px-5 py-2 rounded-full border border-foreground/30 text-foreground text-sm font-semibold tracking-wide transition-colors duration-300 group-hover:bg-mango-blue group-hover:border-mango-blue group-hover:text-white uppercase pointer-events-none">
                      {t("card_button")}
                    </span>
                  </div>
                </a>
                ...
                <div className="pb-6 pt-0 pr-6 pl-0 flex items-center gap-4 bg-card text-left w-full mt-auto relative z-20"> 
                    <a href={item.manufacturer.url} className="flex items-center gap-4 w-full group/company hover:opacity-80 transition-opacity duration-300">
                      ...
                      <div className="flex flex-col gap-1 w-full overflow-hidden">
                          <span className="text-sm font-heading font-bold uppercase tracking-wide text-card-foreground group-hover/company:text-mango-blue leading-tight line-clamp-1 transition-colors duration-300">
