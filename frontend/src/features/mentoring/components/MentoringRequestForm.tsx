      ...
      <DialogContent className="sm:max-w-md rounded-3xl p-0 overflow-hidden border-none shadow-2xl">
        <DialogHeader className="bg-muted/30 border-b p-8">
          <div className="flex items-center justify-between">
            <div>
              <DialogTitle className="text-2xl font-black uppercase tracking-tight text-mango-blue">Ajukan Mentoring</DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <DialogFooter className="pt-2">
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 rounded-xl bg-mango-blue hover:bg-mango-hover text-white font-black uppercase text-xs tracking-widest gap-2 shadow-lg shadow-mango-blue/20"
            >
