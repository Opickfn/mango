...
export function MentoringView() {
  ...
  if (loading) {
    return (
      ...
      >
        <LoadingState message="Verifikasi otoritas akses..." />
      </DashboardPageShell>
    );
  }
  ...
  return (
    <DashboardPageShell
      title={isAdmin ? "Delegasi mentoring" : "Pendampingan UMKM"}
      subtitle={isAdmin ? "Console pusat pengelolaan bantuan dan penugasan advisor." : "Ajukan konsultasi ahli untuk pengembangan bisnis Anda."}
    >
             ...
             <div className="bg-primary p-6 rounded-xl text-white shadow-lg relative overflow-hidden group">
               ...
               <div className="relative z-10">
                 ...
                 <p className="text-white/80 text-sm mb-6 leading-relaxed">
                   Konsultasikan hambatan produksi atau manajemen IKM Anda dengan para ahli dari Politeknik STTT Bandung.
                 </p>
                 <Button 
                   onClick={() => setShowForm(true)}
                   className="w-full bg-white text-primary hover:bg-slate-50 gap-2 shadow-lg"
                 >
      ...
      <MentoringRequestForm 
        ...
        onSuccess={(msg) => {
          setShowForm(false);
          setStatus({ type: "success", message: msg || "Mentoring request submitted successfully" });
          refresh();
        }}
      />
    </DashboardPageShell>
