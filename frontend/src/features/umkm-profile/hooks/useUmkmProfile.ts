  ...
  useEffect(() => {
    if (user?.umkm) {
      form.reset({
        ...
        owner_name: user.umkm.owner_name || "",
        nik: user.umkm.nik || "",
        npwp: user.umkm.npwp || "",
        phone: user.umkm.phone || "",
        website: user.umkm.website || "",
        instagram: user.umkm.instagram || "",
        facebook: user.umkm.facebook || "",
        tiktok: user.umkm.tiktok || "",
        shopee: user.umkm.shopee || "",
        tokopedia: user.umkm.tokopedia || "",
  ...
  const onSubmit = async (data: any) => {
    ...
    Object.keys(data).forEach(key => {
        ...
        if (value !== undefined && value !== null) {
            ...
            } else if (value === "" && ["nik", "nib", "kbli", "latitude", "longitude", "npwp", "village", "shopee", "tokopedia"].includes(key)) {
                // Skip empty strings
            } else {
