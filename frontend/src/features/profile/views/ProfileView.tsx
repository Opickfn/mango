...
import { 
    ...
    Activity, Settings, Globe, LogOut, Trash2, Key
} from "lucide-react";
            ...
            <div className="lg:col-span-4 h-full">
              <div className="bg-white border border-border/50 rounded-[2.5rem] p-10 shadow-sm h-full flex flex-col items-center text-center relative overflow-hidden">
                ...
                <div className="relative z-10 w-32 h-32 bg-white rounded-[2.5rem] mb-8 mt-6 overflow-hidden border-2 border-white shadow-md">
                  <div className="w-full h-full bg-primary/5 rounded-[2rem] flex items-center justify-center text-primary overflow-hidden">
                    {user.avatar_url ? (
                        <img src={user.avatar_large || user.avatar_url} alt={user.name} className="w-full h-full object-cover" />
                    ) : (
