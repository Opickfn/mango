...
export function CampusInfoView() {
  const {
    campus,
    loading,
    submitting,
  ...
  if (!campus) return (
    <DashboardPageShell title="Informasi kampus" subtitle="Identitas institusi" icon={Landmark}>
  ...
  return (
    <DashboardPageShell
        ...
        subtitle="Kelola identitas resmi institusi dalam ekosistem MANGO."
        icon={Landmark}
    >
                        ...
                        <form onSubmit={onSubmit}>
                            <CardContent className="p-6 space-y-5">
                                <div className="space-y-2">
                                    ...
                                    <Input {...form.register("name")} className="h-11 rounded-lg bg-muted/30 border-transparent focus:bg-background transition-all font-medium" />
                                </div>
            ...
            <div className="lg:col-span-1 space-y-6">
                <Card className="bg-slate-900 text-white border-slate-800">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-semibold text-primary">Identity card</CardTitle>
                    </CardHeader>
                    <CardContent className="p-6 pt-2 space-y-6">
                        <div className="flex flex-col items-center py-4">
                            <div className="w-24 h-24 bg-white/10 rounded-full flex items-center justify-center mb-4 ring-4 ring-white/5 shadow-2xl">
                                <School size={48} className="text-white" />
                            </div>
                            <h3 className="text-xl font-semibold text-center">{campus.name}</h3>
                            <p className="text-xs font-medium text-white/40 mt-1">Official member</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
