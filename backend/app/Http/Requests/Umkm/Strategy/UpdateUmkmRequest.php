...
class UpdateUmkmRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        ...
        $nullableFields = [
            'latitude', 'longitude', 'production_area_size',
            'electricity_capacity', 'employee_count',
            'established_year', 'npwp', 'website', 'instagram', 'facebook', 'tiktok', 'shopee', 'tokopedia',
            'water_source', 'village',
            'nik', 'nib', 'kbli',
    ...
    public function rules()
    {
        return [
            ...
            'kbli' => ['sometimes', 'nullable', 'string', 'size:5'],
