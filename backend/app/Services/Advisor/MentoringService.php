...
class MentoringService
{
    ...
    public function getRequests(
        ...
        if (
            ...
            // UPT can see requests from their own institution
            $organizationIds = $user->institutionOrganizations()->pluck('institutions.id');
            $query->whereIn('institution_id', $organizationIds);
    ...
    public function createRequest(
        ...
        return ConsultationRequest::create([
            'institution_id' => $user->umkm->managed_by_institution_id,
